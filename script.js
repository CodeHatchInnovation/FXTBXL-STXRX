document.addEventListener('DOMContentLoaded', () => {
    const productos = [
        ...
        { id: "p7", nombre: "Puma Future Ultimate", precio: 4199, desc: "Ajuste adaptativo FUZIONFIT360. Diseñado para los creadores de juego.", img: "https://placehold.co/600x600/ffffff/7c3aed?text=Puma+Future", tallas: [27, 28, 29] },
        { id: "p8", nombre: "Mizuno Morelia Neo IV", precio: 5600, desc: "K-Leather de élite. El estándar de oro de la artesanía japonesa.", img: "https://placehold.co/600x600/ffffff/7c3aed?text=Mizuno+Neo", tallas: [26, 27, 28] },
        { id: "p9", nombre: "Nike Tiempo Legend 10", precio: 3499, desc: "Piel sintética avanzada FlyTouch Lite para un control de balón superior.", img: "https://placehold.co/600x600/ffffff/7c3aed?text=Nike+Tiempo", tallas: [25, 26, 27] }
    ];
